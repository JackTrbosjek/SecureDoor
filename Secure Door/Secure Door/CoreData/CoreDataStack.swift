...
class CoreDataStackImplementation: CoreDataStack {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Secure_Door")
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Secure_Door", withExtension: "momd")!
    ...
    func saveContext () {
        if #available(iOS 10.0, *) {
            ...
            // iOS 9.0 - however you were previously handling it
